...
*** Paso 1 -- Ajustes de la bala en =Ajustes=
...
*** Paso 3 -- Almacenar las balas en un grupo
...
*** Paso 4 -- Disparar con la barra espaciadora

**** 4.1 Detectar la tecla
...
**** 4.3 Actualizar y dibujar las balas en el game loop
...
*** Paso 5 -- Eliminar balas fuera de pantalla
...
*** Paso 6 -- Limitar el numero de balas
...
*** Paso 7 -- Refactorizar: =_actualizar_balas()=
...
#+begin_quote
/"Disparar es facil. Lo dificil es saber cuando no disparar."/ -- Cualquier jugador con solo 3 balas
#+end_quote

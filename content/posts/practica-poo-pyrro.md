...
{{< figure src="/images/pyrro-art-NLLM.png" >}}


## Práctica POO — Pyrro: Programación Orientada a Objetos con perros ASCII {#práctica-poo-pyrro-programación-orientada-a-objetos-con-perros-ascii}
...
### Descarga los ficheros incompletos {#descarga-los-ficheros-incompletos}

-   [pyrro-dice_incompleto.py](/code/poo/pyrro-dice_incompleto.py)
-   [pyrro-art_incompleto.py](/code/poo/pyrro-art_incompleto.py)

Renómbralos a `pyrro-dice.py` y `pyrro-art.py` antes de empezar.


## Fichero 1: `pyrro-dice.py` (estilo funcional) {#fichero-1-pyrro-dice-dot-py--estilo-funcional}
...
### Pistas para `pyrro-dice.py` {#pistas-para-pyrro-dice-dot-py}
...
-   `__name__ =` "<span class="underline">_</span>"= — ¿Qué valor especial tiene `__name__` cuando ejecutas un script directamente?


## Fichero 2: `pyrro-art.py` (Programación Orientada a Objetos) {#fichero-2-pyrro-art-dot-py--programación-orientada-a-objetos}
...
### Pistas para `pyrro-art.py` {#pistas-para-pyrro-art-dot-py}
...
### `pyrro-dice.py` {#pyrro-dice-dot-py}
...
## BONUS — Amplía la clase (para nota máxima) {#bonus-amplía-la-clase--para-nota-máxima}
...
## Conceptos clave que aprenderás {#conceptos-clave-que-aprenderás}
...
| **`if __name__ =` "<span class="underline"><span class="underline">main</span></span>"=** | Patrón estándar para scripts ejecutables         |


## Rúbrica de evaluación {#rúbrica-de-evaluación}


### Fichero 1: `pyrro-dice.py` (Estilo funcional) — 3 puntos {#fichero-1-pyrro-dice-dot-py--estilo-funcional--3-puntos}
...
### Fichero 2: `pyrro-art.py` (POO) — 6 puntos {#fichero-2-pyrro-art-dot-py--poo--6-puntos}
...
> _"En POO, los objetos son como los perros: cada uno tiene su nombre, su edad y su propia forma de ladrar."_
